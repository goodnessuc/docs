...
description: 'Essential Sui CLI commands and usage examples for developers'
icon: 'terminal'
---
...
<img src="/images/cli-commands.png" alt="Help on Sui CLI"/>
...
<img src="/images/generate-key-cli.png" alt="Generate Key Sui CLI"/>
