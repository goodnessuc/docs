...
description: "Fast-track tutorial to get started with Sui Move programming"
icon: "clock"
---
...
![The Move.toml File](/images/move-toml.png)
...
![Distinguishing addresses](/images/addresses.png)
...
![Example of Published Package](/images/published.png)
...
Strings in Move are _not_ like JS or Python strings. They’re byte arrays with UTF-8 encoding in the `String` module.
