...
description: 'Step-by-step guide to deploying websites on Walrus decentralized storage'
icon: 'globe'
---
...
<img src="/images/deployed.png" alt="Site Deployed"/>
